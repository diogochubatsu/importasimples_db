#!/usr/bin/env python3
"""
Category Resolver — shared utility for all ImportaSimples agents.

Usage:
    from category_resolver import resolve_category, ensure_category, add_platform_mapping
    ...
    # Returns: {'silver_category_id': 4, 'confidence': 0.9, 'l1': 'Iluminação', ...}
